...
[KTANE_IRL Code of Conduct](blob/master/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report unacceptable behavior
to <itoncek@itoncek.space>.

## I Have a Question

> If you want to ask a question, we assume that you have read the
> available [Documentation](https://madebyitoncek.github.io/ktane_irl/).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  components/versions (Make sure that you have read the [documentation](https://madebyitoncek.github.io/ktane_irl/). If
...
> tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <itoncek@itoncek.space>.
...
This section guides you through submitting an enhancement suggestion for KTANE_IRL, **including completely new features
...
- Make sure that you are using the latest version.
- Read the [documentation](https://madebyitoncek.github.io/ktane_irl/) carefully and find out if the functionality is
...
- **Explain why this enhancement would be useful** to most KTANE_IRL users. You may also want to point out the other
